...
if(!empty($miraculous_theme_data['logo_svgcode'])):
   $logo_svgcode = $miraculous_theme_data['logo_svgcode'];
	...
	if(!empty($miraculous_theme_data['logo_image']['url'])):
	   $logoimage_url = $miraculous_theme_data['logo_image']['url'];
...
?>
<div class="div-wrapper-<?php echo esc_attr($header_style); ?>"><!-- #div-wrapper-style -->
...
elseif(!empty($miraculous_theme_data['loginbar_switch_value'])):
