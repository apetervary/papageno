 ...
 */ 
require get_template_directory() . '/vendor/miraculous-multivendor-functions.php';

/**
 * Miraculous Theme Option
 */ 
require get_template_directory() . '/vendor/redux/miraculous-options.php';

require get_template_directory() . '/vendor/redux/custom-extensions/loader.php';

/**
 * Redux Option
 */
function mira_global_redux(){
	global $mira_redux;
	return $mira_redux;
}

function mira_global_options(){
	global $mira_options;
	return $mira_options;
}
...
function miraculous_theme_breadcrumbs() {
	...
	if ( class_exists( 'ReduxFramework' ) ) {
		$header_breadcrumb_data = '';
		$header_breadcrumb_data = get_option('miraculous_options');
	}
    ...
    if ( class_exists( 'ReduxFramework' ) ) {
        if(!empty($header_breadcrumb_data['loginbar_switch_value'])):
            $top_header_login_bar =  $header_breadcrumb_data['loginbar_switch_value'];
        endif;
	}
   if($top_header_login_bar == 'on' || $top_header_login_bar == 1):
