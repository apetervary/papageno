...
$footer_show ='';
	if(!empty($miraculous_theme_data['footer_show'])):
	   $footer_show = $miraculous_theme_data['footer_show'];
	endif;
	
if($footer_show == 'on' || $footer_show == '1'){
?>
		...
		if(!empty($miraculous_theme_data['flogo_image']['url'])):
		   if (function_exists('fw_get_db_settings_option')){
		     $footer_logo_image = $miraculous_theme_data['flogo_image']['attachment_id'];
               ...
               $footer_logo_image = $miraculous_theme_data['flogo_image']['id'];
           }
        ...
        <div class="ms_copyright">
            ...
            <div class="site-info">
                <?php if(!empty($footer_copyrigth)): ?>
                    <p><?php echo esc_html($footer_copyrigth); ?></p>
                <?php else: ?>
                   <p><?php esc_html_e('&copy; Copyright 2022, All Rights Reserved','miraculous'); ?><a href="<?php echo esc_url('https://themeforest.net/user/kamleshyadav'); ?>">
