...
$options = array(
    'header_settings' => array(
        ...
        'options' => array(
            'menuopen_switch_value' => array(
			          'label' => __('Theme Menu Open Enable/Disable', 'miraculous'),
			          'type'  => 'switch',
			          'right-choice' => array(
			                 'value' => 'on',
			...
			'themeloginbar_switch' => array(
				...
				'picker' => array(
			        'loginbar_switch_value' => array(
			                'label' => __('Theme Top Header Enable/Disable', 'miraculous'),
			                 'type'  => 'switch',
			                 'right-choice' => array(
			                      'value' => 'on',
			                      'label' => __('On', 'miraculous')
			...
			'header_style' => array(
                ...
                'value' => esc_html__('header-one', 'miraculous'),
                    'choices' => array(
                        ...
                        'style-two' => esc_html__('Header Two', 'miraculous'),
                ),
            ),
            //'header_bg' => array(
                    //'type'  => 'color-picker',
                    //'value' => '#000000',
                    //'label' => __('Header Background Color', '{domain}'),
                    //'desc'  => __('Header Background Color', '{domain}'),
                    //'help'  => __('Select Color ', '{domain}'),
                //)
         )
    )
);