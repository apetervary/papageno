...
$options = array(
    ...
    fw()->theme->get_options( 'customizer/miraculous-unregis-player'),
    fw()->theme->get_options( 'customizer/miraculous-payment-api-setting'),
    fw()->theme->get_options( 'customizer/miraculous-woocommerce-setting'),
   ); 